# Higedan Bridge: Bilingual Lyric Engine
> A J-Pop lyric website designed to help Japanese learners bridge the gap between music and meaning.

## Project Overview
Initially developed during my JLPT N5 studies to combine my passion for a Japanese band called **Official Hige Dandism**. I am currently refactoring the codebase from a static multipage site into a dynamic, data-driven web application to improve scalability and User Experience with a goal to improve my current skills as a Computer Engineering student and a Japanese learner (currently JLPT N3) 
...
3. Integrated Media & Learning Tools
...
Responsive Layout:
Refactored CSS to ensure the site works well on different screen sizes.
